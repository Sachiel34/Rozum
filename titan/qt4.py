...
class RobotExecutorApp(QWidget):
    ...
    def __init__(self):
        ...
        self.all_button.setStyleSheet(build_style(
            "rgb(240,255,240)", "rgb(120,200,120)",
            "font-size:18px; height:60px; width:200px; border-radius:15px; margin-top:12px; border:2px solid #007F00;"
        ))
        ...
        self.stop_button.setStyleSheet(build_style(
            ...
            "font-size:22px; height:60px; width:200px; border-radius:15px; margin-top:20px; border:2px solid #8B0000;"
        ))
