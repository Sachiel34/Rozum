...
class RobotExecutorApp(QWidget):
    ...
    def __init__(self):
        ...
        # ----- ввод параметров -----
        input_layout = QHBoxLayout()  # Поля ввода и кнопка будут в одном ряду
        ...
        input_layout.addWidget(self.steps_input, 1)  # Занимает 50% ширины

        # Поле ввода времени шага
        ...
        input_layout.addWidget(self.second_input, 1)  # Занимает 50% ширины

        # ----- кнопка Подтвердить -----
        self.confirm_button = QPushButton("Подтвердить")
        self.confirm_button.setStyleSheet(
            """
            background-color: rgb(221,160,221);  # сиреневый
            font-size: 17px;
            height:40px; 
        ...
        input_layout.addWidget(self.confirm_button, 0)  # Кнопка квадратная
        ...
        self.stop_button.setStyleSheet(
            ...
            border-radius:20px; 
            margin-top:20px;
            border: 3px solid #8B0000;  # Темно-красная рамка
            """
        )
